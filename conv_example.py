...
test_images = np.random.randint(10,28,28) #mnist.test_images()[:1000]
test_labels = np.random.randint(1,10,size=(10,)) #mnist.test_labels()[:1000]

# We only use the first 1k examples of each set in the interest of time.
# Feel free to change this if you want.
train_images = np.random.randint(1,255,size=(10,28,28)) 
train_labels = np.random.randint(1,10,size=(10,))
test_images = np.random.randint(10,28,28) 
test_labels = np.random.randint(1,10,size=(10,))
